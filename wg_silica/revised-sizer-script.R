...
# Test identification of specific bandwidths
...
# Graph aggregated plots
sizer_ggplot(raw_data = test_site, sizer_data = sizer_tidy,
             x = "Year", y = "FNYield")

# Graph one non-aggregated bandwidth
sizer_ggplot(raw_data = test_site, sizer_data = sizer_h3,
             x = "Year", y = "FNYield")
