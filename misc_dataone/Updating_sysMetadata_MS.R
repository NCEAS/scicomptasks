...
pid_r <- c("msleckman.25.1","msleckman.26.1","msleckman.34.1","msleckman.35.1","msleckman.36.1")

#pids_word <- c("brun.53.1","karakoenig.71.2","karakoenig.83.1")

#pids_zip <- c("karakoenig.96.1", "karakoenig.95.2")

#pids_csv <- c("karakoenig.84.1", "karakoenig.92.1", "karakoenig.93.1", "karakoenig.94.1", "kengmiller.31.1")
